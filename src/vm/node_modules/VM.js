                ...
                if (data.hasOwnProperty('manifest')) {
                    ...
                    if (data.manifest.hasOwnProperty('image_size')) {
                        if (image.target.hasOwnProperty('image_size')) {
                            if (image.target.image_size
                                !== data.manifest.image_size) {
                                log.error('incorrect image_size value for image'
                                    + ' ' + image.uuid + ' passed: '
                                    + image.target.image_size + ' should be: '
                                    + data.manifest.image_size);
                                errors.bad_values.push(image.property_prefix
                                    + '.image_size');
                            }
                        } else {
                            image.target.image_size = data.manifest.image_size;
